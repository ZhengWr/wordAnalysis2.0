...
$(document).ready(function(){
	if(!browser.versions.mobile){
		...
		if(!_st)_st=0;
		var _code = '<div id="fixed"><dl><dd><a href="http://sc.chinaz.com/" class="web">分析一</a></dd><dd><a href="http:/sc.chinaz.com/" class="mb">分析二</a></dd><dd><dd><a href="http://sc.chinaz.com/" class="pk165">分析三</a></dd><dt><a href="javascript:void(0);" class="close"></a></dt></dl></div>';
		if(_st==1){
